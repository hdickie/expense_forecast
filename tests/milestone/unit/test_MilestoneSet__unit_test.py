...
#
#         C_1 = CompositeMilestone('C1',[],[])
#         C_2 = CompositeMilestone('C2',[],[])
#
#
#         MilestoneSet(
#             [A_1,A_2],
...
#     #     B.addBudgetItem('20000101', '20000101', 1, 'once', 10, 'memo_regex2', False, False)
#     #
#     #     A_1 = AccountMilestone('Milestone_1', 'Shmaccount_Name1', 0, 100) #name not found error
...
#     #     B.addBudgetItem('20000101', '20000101', 1, 'once', 10, 'memo_regex2', False, False)
#     #
#     #     M_1 = MemoMilestone('Milestone_3', 'shmemo_regex1') #no match possible
#     #
#     #     with pytest.raises(ValueError):
#     #         MilestoneSet(A, B,
#     #                                   [],
