...
class TestBudgetSetMethods(unittest.TestCase):
    ...
    def test_getBudgetSchedule(self):
        test_budget_set = BudgetSet.BudgetSet()
        test_budget_set.addBudgetItem(start_date_YYYYMMDD='20220101',end_date_YYYYMMDD='20230101',priority=1,cadence='daily',amount=0,deferrable=False,memo='test'
                                      #,throw_exceptions=False
                                      )
        test_budget_set.addBudgetItem(start_date_YYYYMMDD='20220101', end_date_YYYYMMDD='20230101', priority=1, cadence='once', amount=0,deferrable=False, memo='test 0')
        test_budget_set.addBudgetItem(start_date_YYYYMMDD='20220101', end_date_YYYYMMDD='20230101', priority=1, cadence='weekly',amount=0,deferrable=False, memo='test 1')
        test_budget_set.addBudgetItem(start_date_YYYYMMDD='20220101', end_date_YYYYMMDD='20230101', priority=1, cadence='biweekly',amount=0,deferrable=False, memo='test 2')
        test_budget_set.addBudgetItem(start_date_YYYYMMDD='20220101', end_date_YYYYMMDD='20230101', priority=1, cadence='monthly',amount=0,deferrable=False, memo='test 3')
        test_budget_set.addBudgetItem(start_date_YYYYMMDD='20220101', end_date_YYYYMMDD='20230101', priority=1, cadence='quarterly',amount=0,deferrable=False, memo='test 4')
        test_budget_set.addBudgetItem(start_date_YYYYMMDD='20220101', end_date_YYYYMMDD='20230101', priority=1, cadence='yearly',amount=0,deferrable=False, memo='test 5')
