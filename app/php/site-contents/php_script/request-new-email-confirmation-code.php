...
if ( ( $username_query_result[0] > 0 ) && ( $conf_query_result[0] > 0 ) ){
	...
	$insert_q = "INSERT INTO email_confirmation_codes (username, confirmation_code, valid_until) VALUES ('".$_POST["username"]."','".$confirmation_code."','".$valid_until_ts."')";
