...
$q = "INSERT INTO prod.ef_account_milestones_".$username."_temporary Select '".$_POST["accountmilestonename"]."',".$_POST["accountmilestoneminbalance"].",".$_POST["accountmilestonemaxbalance"];
