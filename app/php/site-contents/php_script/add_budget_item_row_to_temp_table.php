...
if ( isset($_POST["optionalbudgetitem"]) ){
	$target_table_name = "prod.ef_budget_item_set_optional_".$username_according_to_server."_temporary";
} else {
	$target_table_name = "prod.ef_budget_item_set_".$username_according_to_server."_temporary";
}
