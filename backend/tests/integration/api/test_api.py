...
class TestDraftIntegration:
    ...
    def test_POST_draft_submit(self):
    ...
    @pytest.mark.integration
    def test_POST_report_problem(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_POST_report_error(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_POST_draft_parameter_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_POST_draft_account_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_POST_draft_lineitem_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_POST_draft_decisionrule_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_POST_draft_milestone_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_draft_parameter_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_draft_account_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_draft_lineitem_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_draft_decisionrule_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_draft_milestone_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_browse_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_view_forecast_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_view_sankey_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_view_milestone_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_GET_view_lineitem_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_DELETE_forecast_user(self):
        raise NotImplementedError
    
    @pytest.mark.integration
    def test_DELETE_draft_user(self):
        raise NotImplementedError