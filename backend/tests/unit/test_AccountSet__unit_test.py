...
class TestAccountSet:
    ...
    def test_determineMinCCPaymentAmount(
        self,
        test_name,
        ...
        if expected_result == -1:
            ...
            try:
                ...
                # )
                # test_name, advance_payment_amount, interest_accrued_this_cycle, principal_due_this_cycle, total_balance_post_accrual, min_payment, expected_result
                # params = CreditCardAccountParams(
                #     name="Test Card",
                #     min_balance=0,
                #     max_balance=5000,
                #     account_type=AccountType.CREDIT,
                #     current_statement_balance=1200.0,
                #     previous_statement_balance=1100.0,
                #     billing_start_date=datetime(2024, 4, 1),
                #     apr=0.25,
                #     minimum_payment=35.0,
                #     end_of_previous_cycle_balance=1000.0,
                # )
                # A = AccountSet.AccountSet()
                # A.createCreditCardAccount(params)
