...
def generate_date_sequence(start_date, num_days, cadence):
    ...
    if cadence.lower() == "once":
        ...
        return_series = relevant_semiweekly_schedule + datetime.timedelta(
            days=day_delta
        )
        ...
        end_date = end_date - datetime.timedelta(days=day_delta)
        relevant_semiweekly_schedule = pd.date_range(start_date, end_date, freq="W-MON")
        result_sequence = relevant_semiweekly_schedule + datetime.timedelta(
            days=day_delta
        )
        ...
        return_series = first_of_each_relevant_month + datetime.timedelta(
            days=day_delta
        )
        ...
        return_series = first_of_each_relevant_quarter + datetime.timedelta(
            days=day_delta
        )
