...
class InvestmentBillingState:
    ...
    def __init__(self, 
        ...
        expected_apr : Decimal
            ...
            For example, use ``Decimal("0.07")`` for an expected annual return
            of 7%.
        ...
        expected_apr = Decimal(str(expected_apr))
    ...
    def accrue_return(self, days=1) -> Decimal:
        ...
        daily_growth_factor = Decimal("1") + self.apr / Decimal("365.25")
